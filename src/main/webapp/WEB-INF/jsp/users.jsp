            ...
            <c:forEach items="${users}" var="user">
                ...
                <tr id="${user.id}">
                    ...
                    <td><input type="checkbox"
                               <c:if test="${user.enabled}">checked</c:if> id="${user.id}" onclick="setUserStatus($(this), ${user.id})" {
                               }
                               setUserStatus($this)"/></td>
                    <td><fmt:formatDate value="${user.registered}" pattern="dd-MMMM-yyyy"/></td>
                    <%--<td><a><span class="fa fa-pencil"></span></a></td>--%>
                    <td><a onclick="editRow(${user.id})"><span class="fa fa-pencil"></span></a></td>
